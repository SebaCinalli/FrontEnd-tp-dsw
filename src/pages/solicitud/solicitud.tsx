...
export function Solicitud() {
  ...
  const handleGuardarServicios = async (solicitudId: number) => {
    try {
      ...
      if (serviciosSeleccionados.djId !== undefined) {
        updateData.djId = serviciosSeleccionados.djId;
      }
      if (serviciosSeleccionados.salonId !== undefined) {
        updateData.salonId = serviciosSeleccionados.salonId;
      }
      if (serviciosSeleccionados.barraId !== undefined) {
        updateData.barraId = serviciosSeleccionados.barraId;
      }
      if (serviciosSeleccionados.gastronomicoId !== undefined) {
      ...
      alert(
        'Error al actualizar los servicios: ' +
          (error.response?.data?.message || 'Error desconocido')
      );
    }
  };
